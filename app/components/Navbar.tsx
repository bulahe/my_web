        ...
        <>
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between h-16">
                ...
                <div className="flex item-center">
                  <Link href="/">
                    <h1 className="text-2xl font-medium">
                      Bulahe <span className="text-teal-500">Chung</span>
                    </h1>
                  </Link>
                </div>
              ...
              {/* 这里是当网页缩小变成只露出那个icon的时候才显示的 */}
              <div className="-mr-2 flex items-center sm:hidden">
                <Themebutton />
                <Disclosure.Button
                  className={
                    "inline-flex item-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-teal-500 dark:hover:bg-gray-800"
                  }
                >
                  {open ? (
                    <svg
